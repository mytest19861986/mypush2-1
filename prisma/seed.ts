...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  SUPER_ADMIN: [
    ...
    'manage_plans', 'manage_contracts', 'manage_visits', 'view_reports', 'manage_roles', 'manage_permissions',
    'upload_documents', 'view_audit_logs', 'manage_settings', 'manage_commissions',
    'manage_payments', 'view_payments', 'grant_user_plans',
  ],
  ADMIN: [
    'manage_users', 'manage_agents', 'approve_agents', 'manage_doctors', 'approve_doctors',
    'manage_plans', 'manage_contracts', 'manage_visits', 'view_reports', 'upload_documents', 'view_audit_logs',
    'manage_payments', 'view_payments', 'grant_user_plans',
  ],
